...
export class DepenseComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.depenseService
            ...
            .subscribe(
                (res: HttpResponse<IDepense[]>) => this.paginateDepenses(res.body, res.headers),
    ...
    trackId(index: number, item: IDepense) {
        return item.id;
    }
    ...
    private paginateDepenses(data: IDepense[], headers: HttpHeaders) {
