...
class EmployeeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Employee entity")
        ...
        .repeat(2) {
            ...
            .post("/api/employees")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "tEmploye":"0", "tSocab":"0", "matEmpl":"SAMPLE_TEXT", "idCarte":"0", "nom":"SAMPLE_TEXT", "prenom":"SAMPLE_TEXT", "nCin":"0", "photo":null, "dateDelivCin":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
